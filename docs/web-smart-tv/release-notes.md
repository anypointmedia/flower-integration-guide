...
| ---| ---| --- |
| 2.3.14 | Sep 16, 2026 | **BugFix** <ol><li>Fixed a `NullPointerException` that occurred on the next ad request after `FlowerAdsManager` was terminated when manifest manipulation is not used</li></ol> |
| 2.3.13 | Sep 03, 2026 | **BugFix** <ol><li>Fixed a case where the HLS playlist window grows instead of sliding in Linear TV</li></ol> |
...
| 2.3.7 | May 21, 2026 | **Feature** <ol><li>Added passing of an ad break identifier value in ad requests</li><li>Added support for ad tracking prevention macros</li></ol> |
...
| 2.3.5 | May 6, 2026 | **Feature** <ol><li>Added support for the Google PAL SDK to generate the nonce required for programmatic ad requests</li><li>Improved cache refresh on channel entry to be determined by validity time</li><li>Applied compatibility code for Chrome engine 69 and later</li></ol> |
