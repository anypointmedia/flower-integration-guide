...
| ---| ---| --- |
| 2.3.6 | June 29, 2026 | **Feature** <ol><li>Added support for reusing the splice event ID across different SCTE-35 events in the stream</li></ol> **BugFix** <ol><li>Fixed a resource release error when reusing `FlowerAdView`</li></ol> |
