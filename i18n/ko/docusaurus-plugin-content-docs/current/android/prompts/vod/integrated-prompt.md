...
이 프롬프트는 Android용 Flower SDK 연동 전체를 하나의 프롬프트로 다룹니다. Step 1–4의 전체 내용이 포함되어 있습니다.
...
dependencies {
    ...
    // Add ONLY if APPROACH=flower-player and the project uses FlowerMedia3ExoPlayer.
