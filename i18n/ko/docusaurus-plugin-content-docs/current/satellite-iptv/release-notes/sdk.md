...
| **버전** | **날짜** | **변경내용** |
| --- | --- | --- |
| 2.0.11 | 2026.01.19 | **New** <ol><li>AdPlayer 인터페이스에 볼륨 제어 API 추가 (mute, unmute, setVolume)</li></ol> |
| 2.0.10 | 2026.01.06 | **BugFix** <ol><li>sources.jar 업로드 중단</li><li>CUE_IN 신호에 의해 예정된 큐가 무시되는 점 개선 [Agent v3.9.39 이상 요구 됨]</li><li>고수준 ima-sdk 사용을 제거. 3.28.2 버전에 호환되도록 작업</li></ol> |
| 2.0.9 | 2025.12.08 | **New** <ol><li>SDK 로그를 AppLog에 취합 [Agent v3.9.36 이상 요구 됨]</li></ol> **Feature** <ol><li>Digital start cue가 영역을 구분하여 광고 재생을 예정하도록 개선 [Agent v3.9.36 이상 요구 됨]</li><li>[KT] 광고 재생 시간 변경 제공</li><li>광고 시간보다 늦게 광고 준비가 수신된 경우, -701 에러 발생하도록 조치</li><li>스킵 진행률 복구 기능 추가</li></ol> **BugFix** <ol><li>retainChannelStream이 중간에 변경되는 현상 조치</li><li>내장 플레이어의 resume 기능 복구</li><li>ima-sdk 에서 발생하는 에러 메시지를 요청보고에 함께 보고하도록 개선 [Agent v3.9.36 이상 요구 됨]</li><li>ima-sdk 사용 중 발생하는 메모리 누수 개선</li><li>광고 시간이 임박한 경우, 간혹 영상이 정지상태로 재생되지 않는 문제 조치</li></ol> |
