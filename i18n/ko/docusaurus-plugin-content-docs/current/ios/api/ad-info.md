...
| duration | Int32 | 광고 재생 시간(밀리초) |
| isSkippable | Bool | 광고 건너뛰기 가능 여부 |
| mediaUrl | String | 재생할 광고 크리에이티브 URL |
| extensions | \[String: String\] | 각 원본 {`<Ad />`} 요소의 파싱된 VAST 확장 |
| playTime | Int32 | 현재 광고 재생 시점(밀리초) |
| isClickable | Bool | 광고 클릭 가능 여부 |
