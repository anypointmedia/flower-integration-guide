...
| 3.9.30 | 2025.04.01 | **New** <ol><li>Agnet 앱의 고유 UUID를 조회할 수 있는 UuidContentProvider 제공</li></ol> **BugFix** <ol><li>광고 스킵 시 realPlayTime이 잘못 계산되는 문제 수정</li><li>광고가 정렬되며 프로그래매틱 광고 시간이 일부 잘려 계산되는 문제 수정</li></ol> |
